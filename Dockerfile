...
EXPOSE 8080
COPY target/christmas-tree-animation-lights-*.jar christmas-tree-animation-lights.jar
ADD . target
RUN java -cp christmas-tree-animation-lights.jar io.micronaut.graal.reflect.GraalClassLoadingAnalyzer \
    && native-image --no-server \
             --allow-incomplete-classpath \
             --class-path christmas-tree-animation-lights.jar \
             ...
             -H:Name=christmas-tree-animation-lights \
             -H:Class=nl.pvanassen.christmas.tree.animation.lights.Application \
...
ENTRYPOINT ["./christmas-tree-animation-lights", "-Djava.awt.headless=true"]
