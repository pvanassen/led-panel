...
EXPOSE 8080
COPY target/christmas-tree-animation-white-lights-*.jar christmas-tree-animation-white-lights.jar
ADD . target
RUN java -cp christmas-tree-animation-white-lights.jar io.micronaut.graal.reflect.GraalClassLoadingAnalyzer \
    && native-image --no-server \
             --allow-incomplete-classpath \
             --class-path christmas-tree-animation-white-lights.jar \
             ...
             -H:Name=christmas-tree-animation-white-lights \
             -H:Class=nl.pvanassen.christmas.tree.animation.white.lights.Application \
...
ENTRYPOINT ["./christmas-tree-animation-white-lights", "-Djava.awt.headless=true"]
