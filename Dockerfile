...
EXPOSE 8080
COPY target/christmas-tree-animation-sunrise-*.jar christmas-tree-animation-sunrise.jar
ADD . target
RUN java -cp christmas-tree-animation-sunrise.jar io.micronaut.graal.reflect.GraalClassLoadingAnalyzer \
    && native-image --no-server \
             --allow-incomplete-classpath \
             --class-path christmas-tree-animation-sunrise.jar \
...
ENTRYPOINT ["./christmas-tree-animation-sunrise", "-Djava.awt.headless=true"]
